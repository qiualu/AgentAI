...
if __name__ == '__main__':
    ...
    parser.add_argument('--modelpath', type=str, default='models/yolov7_640x640.onnx', help="onnx filepath")
    ...
    while (True):
        ...
        # Draw detections
        dstimg = yolov7_detector.draw_detections(frame, boxes, scores, class_ids)
