...
class Manifest:
    ...
    def add_plugin(self, plugin_name):
        ...
        print("add_plugin",self.file_path,plugin_name)

        dd = "from %s.%s.plugin import %s" % (
        ...
        with open(self.file_path, "a+") as f:
            ...
            # 函数来动态执行一个字符串形式的 Python 代码，实现了根据插件名称导入对应的插件模块
            # from plugins.Plugin.plugin import Plugin
